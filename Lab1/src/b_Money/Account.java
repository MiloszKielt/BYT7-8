...
public class Account {
	 ...
	 */
	public void tick() {
		// During testing of Bank's timedPayment method it was discovered that this methods functions wrong and ticks
		// too often, Fixed by removing the additional tick() call in the method
