...
public class Money implements Comparable {
	...
	public Money add(Money other) {
		int newAmount = this.currency.valueInThisCurrency(other.amount, other.currency) + this.amount;
	...
	public Money sub(Money other) {
		int newAmount = this.currency.valueInThisCurrency(other.amount, other.currency);
		return new Money(this.amount - newAmount,this.currency);
	}
	...
	public int compareTo(Object other) {
		...
		if(Objects.equals(this.universalValue(), otherMoney.universalValue()))
			return 0;
		else if (this.universalValue() < otherMoney.universalValue())
			return -1;
		else
			return 1;
	}
