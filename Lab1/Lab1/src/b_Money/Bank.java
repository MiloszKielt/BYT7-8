...
public class Bank {
	...
	public void openAccount(String accountid) throws AccountExistsException {
		if (accountlist.containsKey(accountid)) {
			...
			// The previous method wasn't adding new accounts to the list, spotted while checking for AccountExistsException throws in the unit tests
	...
	public void deposit(String accountid, Money money) throws AccountDoesNotExistException {
		// previous if statement triggered if accountid wasn't in the key list. Spotted and fixed during testing of deposit method
		if (!accountlist.containsKey(accountid)) {
